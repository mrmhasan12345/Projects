...
public class aboutpro extends JFrame{
	...
	//	fr.setIconImage(img7);
		...
		lbl = new JLabel("<HTML><br>we did this project as our first year final project.<br>we learnt so many things about graphical user interface.<br>To finish this project we spent about 3 weeks and we hope we did our maximum.<br>Thank you very much, sir, from your lectures we learnt lot of things about java.<br>At the begining of this course we don't know anythig about java now we know<br> somthing about java.<br>We will never forget you sir, Thank you so much.</HTML>");
